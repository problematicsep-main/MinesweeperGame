...
class Cell:
    ...
    def __init__(self, x, y,  is_mine=False):
        ...
        # Append the object the cell.all list
    ...
    def get_cell_by_axis(self, x, y):
        # Return a cell object based on the value of x,
    ...
    def show_cell(self):
        if not self.is_opened:
         ...
         if Cell.cell_count_label_object:
             ...
             # if this was a mine candidate we should configure the background color to SystemButtonFace
